								...
								<div class="inner">
									...
									<ul class="actions">
										...
										<% } else {
											...
											<%= list.get(i).getDay() %>
											<a href="MessageDeleteService.do?num=<%=list.get(i).getNum()%>" class="button next scrolly">삭제하기</a>
											</li><br>
											<% } %>
										<li><a href="MessageDeleteAllService.do" class="button next scrolly">전체삭제하기</a></li>
										<% } %>
									</ul>
								</div>
							</section>
							...
							<section>
								...
								<div class="field half first">
									...
									<div class="field half">
										...
										<input name="receive_email" type="text"  id="email" placeholder="받을 사람 이메일"/>
									</div>
